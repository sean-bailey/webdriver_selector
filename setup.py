...
setuptools.setup(
    ...
    description="webdriver_selector provides a quick and easy way to automatically get the first available webdriver on the system, preconfigured to be incognito and headless.",
